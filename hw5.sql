...
CREATE VIEW v2 AS (
    SELECT CONCAT(u.firstname, ' ', u.lastname) AS person,
...
-- 3. 
-- Выберите все сообщения, отсортируйте сообщения по возрастанию даты отправления (created_at) и найдите
